...
const static char *fragment_shader = "#version 330 core\n"
        ...
        "out vec4 frag_color;\n"
        "void main() {\n"
        "   frag_color = vec4(Color.r, Color.g, Color.b, texture(TEX, Tex_coord).r);\n"
        "}";
...
TextRenderProgram::TextRenderProgram() :
    ...
    // taken from "TextRenderProgram.cpp" of 15-466 game0 base code https://github.com/15-466/15-466-f21-base0
